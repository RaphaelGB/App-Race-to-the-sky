...
public class HistoriaPersonagens extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent x = new Intent(HistoriaPersonagens.this, Splash.class);
                startActivity(x);
                finish();
            }
        });

        //Quando clicar no botão de hambúrguer
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Instanciando o Popmenu
                PopupMenu popup = new PopupMenu(HistoriaPersonagens.this, menu);
    ...
    private void mostrarHome() {
        Intent intent = new Intent(HistoriaPersonagens.this, Splash.class);
        startActivity(intent);
        finish();
    }
    private void mostrarHistoria() {
        Intent intent = new Intent(HistoriaPersonagens.this, Historia_jogo.class);
        startActivity(intent);
        finish();
    }

    private void mostrarPersonagens() {
        Intent intent = new Intent(HistoriaPersonagens.this, HistoriaPersonagens.class);
        startActivity(intent);
        finish();
    }

    private void mostrarAvaliacao() {
        Intent intent = new Intent(HistoriaPersonagens.this, Avaliacao.class);
        startActivity(intent);
        finish();
    }
}
